...
## 開発の背景・経緯
情報システムコースでの学生生活を送る中で、専門科目が増えるにつれて「あと何回授業を休めるのか」「総合評価で合格ラインに達するには次のテストで何点必要なのか」という自己管理が複雑化し、結果として単位を落としてしまうケースを多く目にしてきました。
...
- **留年アラート**: 特定の科目で欠席上限が近づいた場合（残り3回以下）や、落単確定の科目が合計「8単位」以上になった場合に重大な警告を表示します。
